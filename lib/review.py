...
class Review:
    ...
    def instance_from_db(cls, row):
        ...
        if row[0] in cls.all:
            existing_instance = cls.all[row[0]]
            # Update attributes to match the latest DB values
            existing_instance.year = row[1]
            existing_instance.summary = row[2]
            existing_instance.employee_id = row[3]
